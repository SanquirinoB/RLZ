...
int main(int argc, char* argv[]){
	...
	if(argc != 10){
		cout<<"\nUsage: compress reference_text sequence_text output block_size n_threads serialized_reference build_reference? use_metadata? factors_file\n";
	...
	const char *factors_file = argv[9];
