...
CompactedFactorsFastIteratorComparator::CompactedFactorsFastIteratorComparator(sd_vector<unsigned long long> *_factors_starts, vector<pair<unsigned long long, unsigned long long>> *_factors, char *_ref_text, unsigned long long _full_size){
	// factors_starts = _factors_starts;
	rank_factors = sd_vector<unsigned long long>::rank_1_type(_factors_starts);
    select_factors = sd_vector<unsigned long long>::select_1_type(_factors_starts);
	factors = _factors;
	ref_text = _ref_text;
	full_size = _full_size;
}

CompactedFactorsFastIteratorReverseComparator::CompactedFactorsFastIteratorReverseComparator(sd_vector<unsigned long long> *_factors_starts, vector<pair<unsigned long long, unsigned long long>> *_factors, char *_ref_text, unsigned long long _full_size){
	// factors_starts = _factors_starts;
	rank_factors = sd_vector<unsigned long long>::rank_1_type(_factors_starts);
    select_factors = sd_vector<unsigned long long>::select_1_type(_factors_starts);
	factors = _factors;
